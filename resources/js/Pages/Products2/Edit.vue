    ...
    data(){
        ...
        return {
            ...
            form: {
                ...
                expiry_date_range: this.product.expiry_date_range,
                take_portion: this.product.take_portion,
                is_public: this.product.is_public,
                                ...
                                <div class="grid grid-rows-3 grid-flow-col ">
                                    <div class=" row-span-4  pl-2">
                                        <center>
                                            ...
                                            <img class="el-upload-list__item-thumbnail" :src="form.image" alt="" width="128"/>
                                        </center>
                                    <el-dialog v-model="dialogVisible">
                                        <img w-full :src="form.image" alt="Preview Image" />
                                    </el-dialog>
                                    </div>
