    ...
    data(){
        ...
        return {
            form: {
                ...
                email: this.customRecord.email,
                phone: this.customRecord.phone,
                address: this.customRecord.address,
                city: this.customRecord.city,
                state: this.customRecord.state,
                zip: this.customRecord.zip,
                country: this.customRecord.country,
    ...
    methods:{
        ...
        submit(){
            ...
            if(localValidation.isValid){
                axios.put(this.route('accounts.update', this.customRecord.id), this.form).then(response => {
                    console.log(response);
                    this.$inertia.visit(route('accounts.show', this.customRecord.id));
                    this.loading = false;
                }).catch(error => {
                    console.log(error);
                    this.loading = false;
