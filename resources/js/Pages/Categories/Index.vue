...
<template>
    <AppLayout title="Gastos">
        <template #header>
            <h3 class="text-lg text-gray-900"> Listado de categorias - # {{ categories.length }}</h3>
            <p class="text-sm text-gray">Catalogo de categorias registradas </p>
        </template>
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-2">
            <div class="flex flex-row m-1">
                <div class="basis-1/2">
                    <inertia-link :href="route('categories.create')" class="m-1"> 
                        <PrimaryButton >
                            Nueva categoría
                        </PrimaryButton>
                    </inertia-link> 
            ...
            <el-table :data="filterTableData" class="shadow-lg m-1" stripe  >
                <el-table-column align="left" width="70" fixed="left">
                    <template #default="scope">
                        <inertia-link :href="route('categories.show', scope.row.id)" >
                ...
                <el-table-column prop="name" label="Nombre de categoría" width="200" sortable/>
