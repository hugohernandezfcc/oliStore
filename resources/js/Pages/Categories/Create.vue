                ...
                <FormSection >
                    ...
                    <template #form>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="name" value="Nombre de categoría" />
                            <TextInput
                                id="name"
                                v-model="form.name"
                                type="text"
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <InputLabel for="status" value="Nivel de categoría" />
                            ...
                            <el-select
                                ...
                                <el-option
                                    v-for="item in [
                                        { label: 'Categoría principal', value: 'Category' },
                                        { label: 'Sub categoría', value: 'Sub_Category' }
                                    ]"
                                    :key="item.value"
                                    :label="item.label"
                                    :value="item.value"
