    ...
    methods:{
        eliminar() {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                this.$inertia.delete(route('liabilities.destroy', this.customRecord.id));
            }
        },
    },
    data(){
        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <inertia-link :href="route('liabilities.edit', customRecord.id)">
                    <PrimaryButton  class="mb-3 ml-3 lg:ml-0"> Editar gasto </PrimaryButton>
                </inertia-link>
                ...
                <FormSection >
                    ...
                    <template #details>
                        ...
                        <el-descriptions title="Detalle del Gasto" :column="1" border>
                            ...
                            <el-descriptions-item label="Porcentaje" label-align="right" align="left" width="80px">
                                <span >{{customRecord.percentage}} %</span>
                            </el-descriptions-item>
                            <el-descriptions-item label="Periodo" label-align="right" align="left" width="80px">
                                <span >{{customRecord.financial.name}}</span>
                            </el-descriptions-item>
                        </el-descriptions>
