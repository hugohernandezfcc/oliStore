    ...
    methods:{
        ...
        submit(){
            ...
            if(localValidation.isValid){
                this.$inertia.post(this.route('financials.store'), this.form);
            }else{
                ...
                <FormSection >
                    ...
                    <template #form>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <LookupField :firstLine="'name'" :secondLine="'street'"  ref="lookupProduct" :likeDataFx="{
