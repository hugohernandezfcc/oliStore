...
export default{
    ...
    components:{
        AppLayout, FormSection, PrimaryButton, InputError, InputLabel, TextInput, SecondaryButton, ActionMessage, Field, ArrowLeftBold
    },
    props:{
        provider: Object
...
<template>
    <AppLayout title="Profile">
        <template #header>
            ...
            </PrimaryButton>&nbsp;Detalle del proveedor 
            </h2>
        </template>
        <div>
